...
//       const formDat = new FormData(e.target as HTMLFormElement);
//       const file = formDat.get("media") as File;
//       const name = formDat.get("name") as string;
//       const symbol = formDat.get("ticker") as string;
//       const description = formDat.get("description") as string;
//       const twitter = formDat.get("twitter") as string;
//       const telegram = formDat.get("telegram") as string;
//       const website = formDat.get("website") as string;
...
//             {/* Form */}
//             <form onSubmit={handleLaunchOnPumpFun} className="space-y-6 w-full lg:w-[60%]">
//               {/* Name Input */}
//               <div>
