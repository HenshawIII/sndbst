...
"Monitor price movements for SOL"`}</code>
          ...
          <section id="trading-strategies" className="scroll-mt-24">
            ...
            <div className="bg-[#000] rounded-xl p-6 mb-6">
              <p className="text-gray-300">
                Discover and implement trading strategies with the help of Coinbeast Agent. Whether you are a beginner or an experienced trader, get suggestions for DCA, swing trading, or custom strategies tailored to your goals.
              </p>
            </div>
          </section>
